...
class Settings:
    ...
    jaeger_api_url: str = "http://127.0.0.1:16686/api"
    prometheus_api_url: str = "http://127.0.0.1:9090/api/v1"
    loki_api_url: str = "http://127.0.0.1:3100"
...
def load_settings() -> Settings:
    ...
    return Settings(
        jaeger_api_url=os.getenv("JAEGER_API_URL", "http://127.0.0.1:16686/api").rstrip("/"),
        prometheus_api_url=os.getenv("PROMETHEUS_API_URL", "http://127.0.0.1:9090/api/v1").rstrip("/"),
        loki_api_url=os.getenv("LOKI_API_URL", "http://127.0.0.1:3100").rstrip("/"),
